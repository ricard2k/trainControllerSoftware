...
#define TFT_DC   4  // Data Command control pin - must use a pin in the range 0-31
#define TFT_RST  2  // Reset pin, toggles on startup

#define TFT_WR    6  // Write strobe control pin - must use a pin in the range 0-31
#define TFT_RD    5  // Read strobe control pin

#define TFT_D0   15  // Must use pins in the range 0-31 for the data bus
